...
module "lpg-ui" {
  ...
  lpg_management_server           = "https://${var.rg_prefix}-${var.rg_name}-${var.lpg_management_name}.azurewebsites.net"
  webapp_sku_tier                 = "${var.webapp_sku_tier}"
  webapp_sku_name                 = "${var.webapp_sku_name_2}"
  docker_registry_server_url      = "${var.docker_registry_server_url}"
  docker_registry_server_username = "${var.docker_registry_server_username}"
...
module "lpg-management" {
  ...
  callback_url                        = "https://${var.rg_prefix}-${var.rg_name}-${var.lpg_management_name}.azurewebsites.net"
