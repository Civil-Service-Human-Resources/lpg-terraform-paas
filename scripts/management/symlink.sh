...
ln -s ../00-$ENV/docker-tags-vars.tf
ln -s /keybase/ops/azure/cabinet-azure/00-$ENV/state.tf
ln -s /keybase/ops/azure/cabinet-azure/00-$ENV/$ENV-vars.tf
