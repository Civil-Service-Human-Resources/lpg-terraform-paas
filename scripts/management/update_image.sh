...
echo "Please pass the webapp name, resource group and docker tag (in order)"
echo "Example: ./update_images.sh lpg-lpgdev-learning-locker-api-worker lpgdev cshr/lpg-learning-locker:213ad45eb11f7924fcec151e852bb729476279338f30ffb040daa3f2df896f5c-v2"
if [[ $# -eq 0 ]]; then
