...
module "identity" {
  ...
  envurl                                  = "${var.envurl}"
  invite_signup_url                       = "https://dev2-identity.cshr.digital/signup/%s"
  reset_url                               = "https://dev2-identity.cshr.digital/reset/%s"
}
...
module "civil-servant-registry-service" {
  ...
  check_token_url             = "https://dev2-identity.cshr.digital/oauth/check_token"
