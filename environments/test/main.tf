...
module "identity" {
  ...
  envurl                                  = "${var.envurl}"
  invite_signup_url                       = "https://test-identity.cshr.digital/signup/%s"
  reset_url                               = "https://test-identity.cshr.digital/reset/%s"
}
...
module "civil-servant-registry-service" {
  ...
  datasource                  = "jdbc:mysql://${var.rg_prefix}-${var.rg_name}-${var.mysql_name}.mysql.database.azure.com:3306/civil-servant-registrycivil-servant-registry?user=${var.mysql_user}@${var.rg_prefix}-${var.rg_name}-${var.mysql_name}&password=${var.mysql_pass}&useSSL=true&requireSSL=false"
  vaultresourcegroup          = "${var.vaultresourcegroup}"
  vaultname                   = "${var.vaultname}"
  existingkeyvaultsecretname  = "${var.existingkeyvaultsecretname}"
  certificatename             = "${var.certificatename}"
